...
of your job using the command ``qstat``::
  ...
  qsub -cwd -pe multislot 14 -N velveth_31 -b y \ 
  /usr/bin/velveth velvet_31 31 -shortPaired -fastq -separate read1.fq read2.fq
  
  qsub -cwd -pe multislot 14 -N velveth_51 -b y \ 
